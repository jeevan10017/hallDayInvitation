...
function App() {
  ...
  />
        <div className="text-center space-y-8 animate-fade-in">
          ...
          {selectedDrink === 'AllOfThese' ? (
            <p className="text-2xl text-purple-300">Ready to experience the ultimate party mix! 🎉</p>
          ) : (
            <p className="text-2xl text-purple-300">Your {selectedDrink} will be waiting for you...</p>
          )}
          <div className="mt-8">
            <Wine className="inline-block text-yellow-400 animate-spin-slow" size={48} />
          </div>
          <p className="text-xl text-purple-400 mt-8">Get ready for an unforgettable night!</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-purple-900 text-white relative overflow-hidden">
      ...
      <div className={`max-w-4xl mx-auto px-4 py-16 relative ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="text-center mb-12">
          ...
          {guestName ? (
            <div className="space-y-4">
              <h1 className="text-5xl font-bold animate-glow">Hey {guestName}!</h1>
              <p className="text-2xl text-purple-300">Your Exclusive Invitation Awaits</p>
            </div>
          ) : (
            <h1 className="text-5xl font-bold animate-glow">You're Invited</h1>
          )}
          
          <div className="text-3xl font-light my-8">to an unforgettable night at</div>
          <h3 className="text-4xl font-bold text-purple-400 mb-4">Meghnad Saha Hall of Residence</h3>
          <p className="text-xl text-purple-300 italic">"Where Memories Are Made & Stories Begin"</p>
        </div>
